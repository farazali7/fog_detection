...
def objective(trial):
    ...
    # #number of filters
    # cfg['N_MAX_CONV_FILTERS'] = trial.suggest_int("num_conv_filters", 128, 512, log=True)
    ...
    print(cfg)
    train_mean_acc, val_mean_acc, train_mean_acc, val_mean_auc = train_loso(subjects=cfg['SUBJECTS'], modalities=cfg['MODALITIES'], sample_rate=cfg['SAMPLE_RATE'], win_len=cfg['WIN_LENGTH'], overlap=cfg['OVERLAP'], n_windows=cfg['N_WINDOWS'], num_head=cfg['N_HEADS'], num_ec_layers=cfg['N_ENC_LAYERS'], num_filters=cfg['N_MAX_CONV_FILTERS'], 
